<?php
  ...
  */
class JsonTagCloudAdapter68Test extends PHPUnit_Framework_TestCase
{
	...
	public function setUp()
	{
		...
		$this->tagCloudAdapter = FF::getInstance('json68/tagCloudAdapter', $this->dataProvider, self::$paramsParser, self::$encodingHandler, self::$log);
	}
	...
	public function testTagCloudLoading()
	{
        ...
        $this->assertEquals(0.0334, $tagCloud[0]->getWeight(), 'wrong weight delivered for first tag query', 0.00001);
