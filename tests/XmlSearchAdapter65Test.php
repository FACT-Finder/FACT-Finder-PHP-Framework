 ...
 */
class XmlSearchAdapter65Test extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->searchAdapter = FF::getInstance('xml65/searchAdapter', $this->dataProvider, self::$paramsParser, self::$encodingHandler);
    }
    ...
    public function testGetStatus()
    {
        ...
        $this->assertEquals(FACTFinder_Xml65_SearchAdapter::RESULTS_FOUND, $status);
    }
