 ...
 */
  ...
  */
class XmlSimilarRecordsAdapter69Test extends PHPUnit_Framework_TestCase
{
	...
	public function setUp()
	{
		...
		$this->similarRecordsAdapter = FF::getInstance('xml69/similarRecordsAdapter', $this->dataProvider, self::$paramsParser, self::$encodingHandler, self::$log);
	}
