<?php
  ...
  */
class JsonTagCloudAdapter67Test extends PHPUnit_Framework_TestCase
{
	...
	public function setUp()
	{
		...
		$this->tagCloudAdapter = FF::getInstance('json67/tagCloudAdapter', $this->dataProvider, self::$paramsParser, self::$encodingHandler, self::$log);
	}
