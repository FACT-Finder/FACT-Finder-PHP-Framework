 ...
 */
  ...
  */
class XmlTagCloudAdapter65Test extends PHPUnit_Framework_TestCase
{
	...
	public function setUp()
	{
		...
		$this->tagCloudAdapter = FF::getInstance('xml65/tagCloudAdapter', $this->dataProvider, self::$paramsParser, self::$encodingHandler, self::$log);
	}
