 ...
 */
  ...
  */
class XmlRecommendationAdapter66Test extends PHPUnit_Framework_TestCase
{
	...
	public function setUp()
	{
		...
		$this->recommendationAdapter = FF::getInstance('xml66/recommendationAdapter', $this->dataProvider, self::$paramsParser, self::$encodingHandler, self::$log);
	}
