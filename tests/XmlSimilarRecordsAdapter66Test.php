 ...
 */
  ...
  */
class XmlSimilarRecordsAdapter66Test extends PHPUnit_Framework_TestCase
{
	...
	public function setUp()
	{
		...
		$this->similarRecordsAdapter = FF::getInstance('xml66/similarRecordsAdapter', $this->dataProvider, self::$paramsParser, self::$encodingHandler, self::$log);
	}
