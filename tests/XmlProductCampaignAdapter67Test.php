 ...
 */
  ...
  */
class XmlProductCampaignAdapter67Test extends PHPUnit_Framework_TestCase
{
	...
	public function setUp()
	{
		...
		$this->productCampaignAdapter = FF::getInstance('xml67/productCampaignAdapter', $this->dataProvider, self::$paramsParser, self::$encodingHandler, self::$log);
	}
