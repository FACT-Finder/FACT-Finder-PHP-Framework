 ...
 */
  ...
  */
class JsonRecommendationAdapter69Test extends PHPUnit_Framework_TestCase
{
	...
	public function setUp()
	{
		...
		$this->recommendationAdapter = FF::getInstance('json69/recommendationAdapter', $this->dataProvider, self::$paramsParser, self::$encodingHandler, self::$log);
	}
