 ...
 */
  ...
  */
class XmlSuggestAdapter67Test extends PHPUnit_Framework_TestCase
{
	...
	public function setUp()
	{
		...
		$this->suggestAdapter = FF::getInstance('xml67/suggestAdapter', $this->dataProvider, self::$paramsParser, self::$encodingHandler, self::$log);
	}
