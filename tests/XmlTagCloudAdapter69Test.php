 ...
 */
class XmlTagCloudAdapter69Test extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->tagCloudAdapter = FF::getInstance('xml69/tagCloudAdapter', $this->dataProvider, self::$paramsParser, self::$encodingHandler, self::$log);
    }
    ...
    public function testTagCloudLoading()
    {
        ...
        $this->assertEquals(4, count($tagCloud), 'wrong number of tag queries delivered');
        ...
        $this->assertEquals(16, $tagCloud[0]->getSearchCount(), 'wrong search count for first tag query delivered');
    }
}