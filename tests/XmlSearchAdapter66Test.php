 ...
 */
class XmlSearchAdapter66Test extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->searchAdapter = FF::getInstance('xml66/searchAdapter', $this->dataProvider, self::$paramsParser, self::$encodingHandler);
    }
