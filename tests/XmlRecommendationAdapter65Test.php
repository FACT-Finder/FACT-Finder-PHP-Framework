 ...
 */
  ...
  */
class XmlRecommendationAdapter65Test extends PHPUnit_Framework_TestCase
{
	...
	public function setUp()
	{
        ...
        $this->dataProvider->setFileLocation(RESOURCES_DIR.DS.'responses'.DS.'xml65');
		$this->recommendationAdapter = FF::getInstance('xml65/recommendationAdapter', $this->dataProvider, self::$paramsParser, self::$encodingHandler, self::$log);
	}
	
	public function testRecommendationLoading()
	{
		$this->recommendationAdapter->setProductId('538');
