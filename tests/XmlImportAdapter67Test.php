 ...
 */
  ...
  */
class XmlImportAdapter67Test extends PHPUnit_Framework_TestCase
{
	...
	public function setUp()
	{
		...
		$this->importAdapter = FF::getInstance('xml67/importAdapter', $this->dataProvider, self::$paramsParser, self::$encodingHandler, self::$log);
	}
