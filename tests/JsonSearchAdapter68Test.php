 ...
 */
  ...
  */
class JsonSearchAdapter68Test extends PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var FACTFinder_Xml68_SearchAdapter
     */
	...
	public function setUp()
	{
		...
		$this->searchAdapter = FF::getInstance('json68/searchAdapter', $this->dataProvider, self::$paramsParser, self::$encodingHandler);
	}
    ...
    public function testGetResult()
    {
        ...
        $this->assertEquals(5, $result->getFoundRecordsCount());
        $this->assertEquals(1, count($result));
        $this->assertEquals("15000", $result[0]->getId());
    }
    ...
    public function testAsnLoading()
    {
        ...
        $this->assertEquals(0, $asn[0][2]->getMatchCount());
        
        $this->assertTrue($asn[1]->isMultiSelectStyle());
        $this->assertFalse($asn[1][0]->isSelected());
        $this->assertFalse($asn[1][1]->isSelected());
        $this->assertFalse($asn[1][2]->isSelected());
        
        $this->assertTrue($asn[2]->isSliderStyle());
        $this->assertEquals('Preis', $asn[2]->getName());
        $this->assertEquals('€', $asn[2]->getUnit());
        $this->assertEquals(10, $asn[2]->getDetailedLinkCount());
        $slider = $asn[2][0];
        ...
        $this->assertEquals('Price', $slider->getField());
    }
    ...
    public function testCampaignLoading()
    {
        ...
        $this->assertEquals('221094', $products[0]->getId());
