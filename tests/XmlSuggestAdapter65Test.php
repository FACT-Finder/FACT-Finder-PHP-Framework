 ...
 */
  ...
  */
class XmlSuggestAdapter65Test extends PHPUnit_Framework_TestCase
{
	...
	public function setUp()
	{
		...
		$this->suggestAdapter = FF::getInstance('xml65/suggestAdapter', $this->dataProvider, self::$paramsParser, self::$encodingHandler, self::$log);
	}
