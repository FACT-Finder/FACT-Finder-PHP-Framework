 ...
 */
  ...
  */
class XmlCompareAdapter67Test extends PHPUnit_Framework_TestCase
{
	...
	public function setUp()
	{
		...
		$this->compareAdapter = FF::getInstance('xml67/compareAdapter', $this->dataProvider, self::$paramsParser, self::$encodingHandler, self::$log);
	}
