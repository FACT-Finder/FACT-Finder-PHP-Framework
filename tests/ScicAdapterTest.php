 ...
 */
class ScicAdapterTest extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->dataProvider->setFileLocation(RESOURCES_DIR.DS.'responses'.DS.'http');
        $this->scicAdapter = FF::getInstance('http/scicAdapter', $this->dataProvider, self::$paramsParser, self::$encodingHandler, self::$log);
    }
