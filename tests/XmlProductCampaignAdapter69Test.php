 ...
 */
  ...
  */
class XmlProductCampaignAdapter69Test extends PHPUnit_Framework_TestCase
{
	...
	public function setUp()
	{
		...
		$this->productCampaignAdapter = FF::getInstance('xml69/productCampaignAdapter', $this->dataProvider, self::$paramsParser, self::$encodingHandler, self::$log);
	}
