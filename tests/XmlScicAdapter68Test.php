<?php
class XmlScicAdapter68Test extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->scicAdapter = FF::getInstance('xml68/scicAdapter', $this->dataProvider, self::$paramsParser, self::$encodingHandler, self::$log);
    }
