...
$searchAdapter = FF::getInstance('json69/searchAdapter', $dataProvider_search, $paramsParser, $encodingHandler, $log);
$tagCloudAdapter = FF::getInstance('json69/tagCloudAdapter', $dataProvider_tagCloud, $paramsParser, $encodingHandler, $log);
